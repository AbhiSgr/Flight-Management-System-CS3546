...
<html>
	...
	<body>
		...
		<br>
		<div
			style="background-color: rgba(0, 0, 0, 0.7); margin-left: 30%; margin-right: 30%; padding-bottom: 50px; border-radius: 20px 20px 20px 20px; color: white; margin-top: 20px;">
			...
			<h3
				style="text-align: center; padding-bottom: 10px; font-family: 'Ubuntu', sans-serif; letter-spacing: 1.5px;font-size: 20px;">
				Book Tickets</h3>


			<form name="addflight" method="post" action="/Flight-Management-System/UserFlight"
				style="text-align: center; font-family: 'DM Sans', sans-serif; letter-spacing: 1.13px;">
...
%>
				...
				<table align="center">
					...
					<tr align="center" height="50px">
						<td></td>
						<td align="left"><input type="submit" value="Book"
								style="font-family: 'DM Sans', sans-serif; background-color: #ef9761; color: black; padding: 8px; border-radius: 0px 8px 0px 8px; border-bottom: 3px solid white; letter-spacing: 1.1px;" />
						</td>
					</tr>
				</table>
			</form>
